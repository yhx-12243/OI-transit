function des(key, message, encrypt, mode, iv, padding) {
	...
	else if (padding == 1) {temp = 8 - (len & 7), message += String.fromCharCode(temp).repeat(8), temp == 8 && (len += 8);} // PKCS7 padding
	...
	while (m < len) {
		...
		if (mode == 1) {if (encrypt) left ^= cbcleft, right ^= cbcright; else cbcleft2 = cbclef, cbcright2 = cbcright, cbcleft = left, cbcright = right;}
